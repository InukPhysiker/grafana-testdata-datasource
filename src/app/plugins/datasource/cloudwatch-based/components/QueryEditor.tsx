...
export class QueryEditor extends PureComponent<Props, State> {
  ...
  //   return _.map(this.props.datasource.variables, variable => {
  ...
  isVariable(str: any) {
    return utils.isTemplateVariable(str, this.props.datasource.variables);
  }
  ...
  isContainsVariables() {
    return _.some(['group', 'host', 'application'], field => {
      if (this.target[field] && this.target[field].filter) {
        return utils.isTemplateVariable(this.target[field].filter, this.props.datasource.variables);
      } else {
        return false;
      }
    });
