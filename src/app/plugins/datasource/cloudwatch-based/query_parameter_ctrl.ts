...
export function epicsArchiverQueryParameter() {
  return {
    templateUrl: 'public/app/plugins/datasource/epicsArchiver/partials/query.parameter.html',
    controller: EpicsQueryParameterCtrl,
    restrict: 'E',
    scope: {
      target: '=',
      datasource: '=',
...
// coreModule.directive('epicsArchiverQueryParameter', epicsArchiverQueryParameter);
angular.module('grafana.directives').directive('epicsArchiverQueryParameter', epicsArchiverQueryParameter);
